...
CREATE TABLE IF NOT EXISTS installation_rankings (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    installation_id INT UNSIGNED NOT NULL,
    ...
    CONSTRAINT fk_rankings_installation FOREIGN KEY (installation_id) REFERENCES installations(id) ON DELETE CASCADE,
    KEY idx_rankings_installation (installation_id),
    KEY idx_rankings_keyword (keyword)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
